...
/* HOW TO RUN -
(1) g++ S20190010007_AssignClipping.cpp -o PolygonClipping -lopengl32 -lglew32 -lfreeglut -lglu32
(2) Then, run ./PolygonClipping.exe


/*HOW TO USE - 
(1) Click on the output screen and gently after running the code.
(2) We must be very gentle and cautious while drawing the output. 
(3) To draw the polygon, we must mark various points according to the diagram given in the assignment to draw the given figure.
(4) Also, NOTE : If there is any drag while drawing, the poylgon won't be drawn.
(5) Click d after pointing the points to draw the required polygon.
(6) Now, Click C to clip the ploygon.
*/
