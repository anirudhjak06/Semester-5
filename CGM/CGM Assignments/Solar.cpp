...
void initialize_display()
{
  ...
  //glClearColor specifies the red, green, Blue_color, and alpha values used by glClear to clear the color buffers. xcs specified by glClearColor are clamped to the range 0 1
  glPointSize(1.0);
  glLineWidth(2.0);
}
